  ...
  "inline-flex items-center justify-center rounded-xl text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-0 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        outline:
          "border border-input bg-transparent shadow-sm md:text-lg text-base hover:bg-card hover:text-accent-foreground",
        secondary:
        ...
        ghost2: "text-medium lg:hover:bg-accent dark:text-neutral-400 md:text-base text-sm font-normal text-neutral-600 active:shadow-inner border border-transparent lg:hover:border-neutral-300 lg:dark:hover:border-neutral-700 dark:hover:bg-neutral-800/50",
